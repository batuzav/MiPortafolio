      ...
      <section id="portfolio">
        <div className="row section-intro">
          <div className="col-twelve">
            <h5>Portafolio</h5>
            <h1>Chaca algunos de mis trabajos.</h1>
            <p className="lead">
              He trabajado para agenciad de Marketing desarrollando proyectos
              versatiles, desde wordpress o sistemas más robustos con NodeJS,
              React, React Native, MongoDB, GraphQL. Incluso en proyectos en
              Freelance para empresas o enprendedores.
            </p>
          </div>
        </div>{" "}
        {/* /section-intro*/}
